...
<head>
    ...
    <style>
        ...
        @media screen and (max-width: 1300px) {
            .login-input-container { height: 3.8rem !important; }
        ...
        @media screen and (max-width: 900px) {
            ...
            .login-input { padding: 0.5rem; }
            .login-input-container { padding: 0.5rem; height: 2.4rem !important; }
        }
        ...
        <div class="login-right-panel">
            <div class="login-form-wrapper">
                ...
                <div class="login-titles">
                    <h1 class="login-h1 login-title-white">Bienvenue</h1>
                    <h1 class="login-h1 login-title-blue">chez nous</h1>
                </div>
                ...
                <form action="" method="POST">
                    ...
                    <div class="login-input-group">
                        ...
                        <div class="login-input-wrapper">
                            <input class="login-input" type="text" id="login-identifiant" name="identifiant" minlength="4" maxlength="20" required>
                        </div>
                    </div>
                    ...
                    <div class="login-input-group">
                        ...
                        <div class="login-input-wrapper">
                            <div class="login-input-container">
                                <input class="login-input-password" type="password" id="login-password" name="password" minlength="8" maxlength="20" required>
                    ...
                    <div class="login-form-options">
                        <label class="login-checkbox-container">
                            ...
                            <span>j'accepte les <a href="usecondition" class="login-terms-link">conditions d'utilisation</a></span>
                        </label>
                    </div>

                    <button type="submit" class="login-btn-connect">S'inscrire</button>

                    <div class="login-register-link">
                        Déjà un compte ? <a href="login?origine=<?php echo $redirect ?>">Se connecter</a>
                    </div>
